    ...
    <div x-data="{
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <template x-for="conference in conferences" :key="conference.id">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300">
                        ...
                        <div class="relative">
                            ...
                            <!-- Favorite Button -->
                            <form method="POST" :action="`/conferences/${conference.id}/${conference.is_favorited ? 'unfavorite' : 'favorite'}`" class="absolute top-4 right-4">
                                @csrf
                                <button type="submit">
                        ...
                        <div class="p-6 mt-4">
                            ...
                            <div class="mt-4 space-y-3">
                                ...
                                <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                    ...
                                    <span x-text="conference.location">
                                </div>
